...
* Solomon, D. and Holmes, O. (2026). [AI cheating, leaked papers and marking errors: how exam protests went global](https://www.theguardian.com/global-development/2026/aug/16/ai-cheating-leaked-papers-marking-errors-how-exam-protests-went-global). _The Guardian_. 
...
* The Childcare Benefits scandal (The Netherlands): Adelmant, V., van Veen, C. (2022). [Hollow rights victories? Dutch struggles against digital injustice](https://www.openglobalrights.org/Dutch-struggles-against-injustice-digital-rights-netherlands/). _Open Global Rights_.
...
* Gosciak, J., Boyce, L., Wang, A., and Koenecke, A. (2026). [Scrutinizing Index-Based Risk Assessments: A Case Study in NYC Decision-making for Heat Emergency Management](https://doi.org/10.1145/3805689.3812405). Proceedings of the 2026 ACM Conference on Fairness, Accountability, and Transparency. Association for Computing Machinery, New York, NY, USA, 6659–6701. 
...
**Concrete resources**
* ACPR - Banque de France's resource on [algorithmic equity in the financial sector](https://acpr.banque-france.fr/fr/publications-et-statistiques/publications/lequite-algorithmique-dans-le-secteur-financier) (in French). 
...
* Mittelstadt, B. (2024). [How to use the Artificial Intelligence Act to investigate AI bias and discrimination: A guide for equality bodies](https://equineteurope.org/wp-content/uploads/2025/02/How-to-use-the-AIA-to-investigate-AI-bias-and-discrimination.-A-guide-for-Equality-Bodies.pdf). _Equinet, European Network of Equality Bodies_. 
...
* Tafakul (Jordan) - see *the summary* in Toh, A. (2023). [Automated Neglect: How The World Bank’s Push to Allocate Cash Assistance Using Algorithms Threatens Rights](https://www.hrw.org/report/2023/06/13/automated-neglect/how-world-banks-push-allocate-cash-assistance-using-algorithms). _Human Rights Watch_. 
...
* The Catalonia Region's [Fundamental Rights Impact Assessment](https://www.dpdenxarxa.cat/pluginfile.php/2468/mod_folder/content/0/FRIA_en_def.pdf), with examples.
...
* VioGén (Spain). - see Satariano, A. and Toll Pifarré, R. (2025). [Spain Overhauls Domestic Violence System after Criticism](https://www.nytimes.com/2025/01/17/technology/spain-domestic-violence-algorithm.html). _The New York Times_. 
...
### Optional readings
* Défenseur des droits. (2024). [Algorithms, AI systems and public services: what rights do users have? Critical considerations and recommendations](https://www.defenseurdesdroits.fr/sites/default/files/2025-01/DDD_rapport_algorithmes-systemes-d-IA-et-services-publics_EN_2024_20250109.pdf).
...
* Pi, Y., Li, W., and Singh, J. (2026). [Understanding the Role of Algorithm Registers in AI Governance Through Comparative Analysis of China and the UK](https://doi.org/10.1145/3805689.3806742). In Proceedings of the 2026 ACM Conference on Fairness, Accountability, and Transparency (FAccT '26). Association for Computing Machinery, New York, NY, USA, 3367–3391. 
...
* Kuehnert, B, Johnson, N., Dotan, R., and Heidari, H. (2026). [Disclosure or Marketing? Analyzing the Efficacy of Vendor Self-reports for Vetting Public-sector AI](https://doi.org/10.1145/3805689.3812220). In Proceedings of the 2026 ACM Conference on Fairness, Accountability, and Transparency (FAccT '26). Association for Computing Machinery, New York, NY, USA, 687–713. 
...
* Young, M. (2025). [Gear Shift: Driving Change in Public Sector Technology through Community Input](https://datasociety.net/wp-content/uploads/2025/06/DS_Gear-Shift-Primer-Final.pdf).  
...
* Data and Society's new [AI Civics](https://datasociety.net/ai-civics/) program.
...
* Reporting by 404 Media on a judge in Indiana (USA) using [generative AI in court transcripts](https://www.404media.co/judge-caught-court-reporter-using-ai-transcript-errors/).
* Research on [AI detectors being biased against non-native English writers](https://hai.stanford.edu/news/ai-detectors-biased-against-non-native-english-writers). 
...
Global, not limited to public sector: [The AI Resist List](https://airesistlist.org/#resist-list). 
